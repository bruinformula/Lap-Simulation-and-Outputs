function [acceleration, lateral_acceleration] = Lap_Sim(endurance_coordinates)
...
radii = [15:10:25]; % range of turn radii at which sim will evaluate (ft)
...
[data text] = xlsread(endurance_coordinates,'Scaled');
...
[acceleration lateral_accel] = lap_information(xx);
